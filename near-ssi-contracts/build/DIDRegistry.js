...
let DIDRegistry = (_dec = NearBindgen({}), _dec2 = call({}), _dec3 = view(), _dec4 = call({}), _dec5 = call({}), _dec6 = view(), _dec7 = call({}), _dec8 = call({}), _dec9 = view(), _dec(_class = (_class2 = class DIDRegistry {
  dids = new UnorderedMap("dids");
  credentialDefinitions = new UnorderedMap("credentialDefinitions");
  static schema = {
    dids: {
      class: UnorderedMap,
      value: {
  ...
  constructor() {
    ...
    this.owner = currentAccountId();
    this.schemas = new UnorderedMap("schemas");
  }
  ...
  registerCredentialDefinition({
    ...
    this.credentialDefinitions.set(credDefId, new CredentialDefinition({
      schemaId,
      issuer
    }));
  }
  ...
  getSchema({
    ...
    // near.log("schemaId: " + schemaId);
    if (schema === null) {
      panicUtf8(Uint8Array.from([1]));
    }
    return schema;
  }
}, _applyDecoratedDescriptor(_class2.prototype, "registerDID", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "registerDID"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getDID", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "getDID"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "updateDID", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "updateDID"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "registerCredentialDefinition", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "registerCredentialDefinition"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getCredentialDefinition", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "getCredentialDefinition"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "registerSchema", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "registerSchema"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "addApprovedIssuer", [_dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "addApprovedIssuer"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getSchema", [_dec9], Object.getOwnPropertyDescriptor(_class2.prototype, "getSchema"), _class2.prototype), _class2)) || _class);
function getSchema() {
  const _state = DIDRegistry._getState();
  if (!_state && DIDRegistry._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  const _contract = DIDRegistry._create();
  if (_state) {
    DIDRegistry._reconstruct(_contract, _state);
  }
  const _args = DIDRegistry._getArgs();
  const _result = _contract.getSchema(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(DIDRegistry._serialize(_result, true));
}
function addApprovedIssuer() {
  ...
  const _args = DIDRegistry._getArgs();
  const _result = _contract.addApprovedIssuer(_args);
  DIDRegistry._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(DIDRegistry._serialize(_result, true));
}
function registerSchema() {
  ...
  const _args = DIDRegistry._getArgs();
  const _result = _contract.registerSchema(_args);
  DIDRegistry._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(DIDRegistry._serialize(_result, true));
}
function getCredentialDefinition() {
  ...
  const _args = DIDRegistry._getArgs();
  const _result = _contract.getCredentialDefinition(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(DIDRegistry._serialize(_result, true));
}
function registerCredentialDefinition() {
  ...
  const _args = DIDRegistry._getArgs();
  const _result = _contract.registerCredentialDefinition(_args);
  DIDRegistry._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(DIDRegistry._serialize(_result, true));
}
function updateDID() {
...
function registerDID() {
  ...
  const _args = DIDRegistry._getArgs();
  const _result = _contract.registerDID(_args);
  DIDRegistry._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(DIDRegistry._serialize(_result, true));
}

export { addApprovedIssuer, getCredentialDefinition, getDID, getSchema, registerCredentialDefinition, registerDID, registerSchema, updateDID };
