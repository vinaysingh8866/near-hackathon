...
var _dec, _class, _dec2, _dec3, _dec4, _dec5, _dec6, _class2, _class3;
let Schema = (_dec = NearBindgen({}), _dec(_class = class Schema {
  constructor({
    schemaDetails,
    approvedIssuers
  }) {
...
let SchemaRegistry = (_dec2 = NearBindgen({}), _dec3 = call({}), _dec4 = call({}), _dec5 = call({}), _dec6 = view(), _dec2(_class2 = (_class3 = class SchemaRegistry {
  ...
  onlyOwner() {
    log();
    if (this.owner !== currentAccountId()) {
...
}, _applyDecoratedDescriptor(_class3.prototype, "init", [_dec3], Object.getOwnPropertyDescriptor(_class3.prototype, "init"), _class3.prototype), _applyDecoratedDescriptor(_class3.prototype, "registerSchema", [_dec4], Object.getOwnPropertyDescriptor(_class3.prototype, "registerSchema"), _class3.prototype), _applyDecoratedDescriptor(_class3.prototype, "addApprovedIssuer", [_dec5], Object.getOwnPropertyDescriptor(_class3.prototype, "addApprovedIssuer"), _class3.prototype), _applyDecoratedDescriptor(_class3.prototype, "getSchema", [_dec6], Object.getOwnPropertyDescriptor(_class3.prototype, "getSchema"), _class3.prototype), _class3)) || _class2);
function getSchema() {
  const _state = SchemaRegistry._getState();
  if (!_state && SchemaRegistry._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  const _contract = SchemaRegistry._create();
  if (_state) {
    SchemaRegistry._reconstruct(_contract, _state);
  }
  const _args = SchemaRegistry._getArgs();
  const _result = _contract.getSchema(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(SchemaRegistry._serialize(_result, true));
}
function addApprovedIssuer() {
  ...
  SchemaRegistry._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(SchemaRegistry._serialize(_result, true));
}
...
export { addApprovedIssuer, getSchema, init, registerSchema };
